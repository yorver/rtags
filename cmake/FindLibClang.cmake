...
if (NOT EXISTS ${CLANG_LIBS})
  ...
  if (NOT EXISTS ${CLANG_CLANG_LIB_HACK_CMAKECACHE_DOT_TEXT_BULLSHIT})
    ...
    if (NOT EXISTS ${CLANG_LIBS})
      ...
      file(GLOB CLANG_LIBNAMES "${CLANG_LIBDIR}/libclang*.a")
      string(REPLACE ";" " " CLANG_LIBNAMES "${CLANG_LIBNAMES}")
      set(CLANG_LIBS "${CLANG_LIBS} ${CLANG_LIBNAMES}")
    endif ()
    execute_process(COMMAND ${LLVM_CONFIG_EXECUTABLE} --libs OUTPUT_VARIABLE LLVM_LIBS OUTPUT_STRIP_TRAILING_WHITESPACE)
